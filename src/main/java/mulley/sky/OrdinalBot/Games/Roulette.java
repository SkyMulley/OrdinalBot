...
public class Roulette {
    ...
    private void start() {
        try {
            Emoji emoji1 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji2 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji3 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji4 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji5 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji6 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji7 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji8 = emojis.get(rand.nextInt(4 + 1));
            Emoji emoji9 = emojis.get(rand.nextInt(4 + 1));
            int moneyback = 0;
